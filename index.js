...
const { ticketIssuerId } = process.env
...
client.on('messageCreate', async (message) => {
  ...
  if (message.author.id === ticketIssuerId) {
    ...
    if (
      ...
      try {
        const strikeChannel = client.channels.cache.find((channel) => channel.id === strikeRecord.UniqueId);
        const offenseChannel = client.channels.cache.find((channel) => channel.id === offenseRecord.UniqueId);
